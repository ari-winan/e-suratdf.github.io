    <?php
		if (isset($_REQUEST['submit'])) {
			...
			if (move_uploaded_file($tmp, $path)) {
				$query = "INSERT INTO surat_masuk VALUES('', '$no_agenda', '$no_surat', '$jenis_surat', '$tanggal_surat',NOW(), '$asal_surat', '$isi_ringkas', '$file')";
        ...
        $query = mysqli_query($connect, "SELECT max(no_agenda) as kodeSurat FROM surat_masuk");
	    $data = mysqli_fetch_array($query);
	    $kodeSurat = $data['kodeSurat'];
        
        $urutan = (int) substr($kodeSurat, 4, 4);
                 
        //membuat nomor urut agenda surat_masuk
        $urutan++;
						...
						<form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="no_agenda" class="form-control col-md-7 col-xs-12"  required="required" value="<?php echo $kodeSurat ?>" readonly>
								</div>
							</div>
							<div class="item form-group">
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="tgl_surat" class="form-control has-feedback-left" id="tanggal">
