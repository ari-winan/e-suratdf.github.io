 	...
 	<div class="">
 		...
 		<div class="row">
 			<div class="col-md-12 col-sm-12 col-xs-12">
 				<div class="x_panel">
 					<div class="x_title">
 						<h2>Data Surat Keluar</h2>&nbsp; &nbsp;<a href="admin.php?page=tambah_surat_keluar" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Surat Keluar</a>
 						...
 						<table id="surat_keluar" class="table table-striped table-bordered table-hover">
 							...
 							<tbody>
 								<tr>
 									...
 									<td style="vertical-align: middle;"><?php echo $data ['no_surat'] ?>,<br> <?php echo IndonesiaTgl($data['tgl_kirim']) ?></td>
 									<td>
 										<center>
 											<a href="admin.php?page=edit_surat_keluar&id=<?php echo $data['id']; ?>" class="btn btn-warning" title="Edit"><i class="fa fa-pencil-square-o"></i></a>
 											<a href="admin.php?page=hapus_surat_keluar&id=<?php echo $data['id'] ?>" class="btn btn-danger" title="Hapus"><i class="fa fa-trash-o"></i></a>
 										</center>
 									</td>
 								</tr>
 								<?php 
