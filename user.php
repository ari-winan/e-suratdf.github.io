		...
		<div class="">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title">
						<h2>Data users</h2>&nbsp; &nbsp;
						<!-- <a href="index.php?page=tambah_users" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah users</a> -->
						...
						<table id="user" class="table table-striped table-bordered table-hover">
							...
							<tbody>
								<tr>
									...
									<td>
										<center>
											<a href="admin.php?page=edit_users&id=<?php echo $data['id'] ?>" class="btn btn-warning" title="Edit"><i class="fa fa-pencil-square-o"></i></a>
										</center>
									</td>
								</tr>
								<?php 
